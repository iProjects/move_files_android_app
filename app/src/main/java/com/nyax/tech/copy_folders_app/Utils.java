...
public final class Utils {
    public static final String TAG = com.nyax.tech.copy_folders_app.Utils.class.getSimpleName();
    ...
    public static void log_messages_to_file(String message) throws IOException {
        ...
        try {
            ...
            writer.append("==================================================================");
            writer.append("\n\r");
            writer.append("LOG AT :" + com.nyax.tech.copy_folders_app.Utils.get_current_datetime());
            writer.append("\n\r");
    ...
    public static void log_exception_to_file(Exception sourceException) throws IOException {
        ...
        try {
            ...
            writer.append("==================================================================");
            writer.append("\n\r");
            writer.append("ERROR OCCOURED AT :" + com.nyax.tech.copy_folders_app.Utils.get_current_datetime());
            writer.append("\n\r");
